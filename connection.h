...
#define CONN_SOCKET_STATE_CONN    1
#define CONN_SOCKET_STATE_RESOLV  2
#define CONN_SOCKET_FAIL_RESOLV  -1
#define CONN_SOCKET_FAIL_CONN    -2
#define CONN_SOCKET_FAIL_TIMEOUT -3
#define CONN_SOCKET_FAIL_AUTH    -4
#define CONN_SOCKET_FAIL_WRITE   -5
