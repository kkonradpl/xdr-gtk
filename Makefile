...
xdr-gtk:			alignment.o clipboard.o connection.o connection_read.o graph.o gui.o gui_net.o keyboard.o main.o menu.o pattern.o rdsspy.o scan.o settings.o sha1.o
					$(CC) -o xdr-gtk alignment.o clipboard.o connection.o connection_read.o graph.o gui.o gui_net.o keyboard.o main.o menu.o pattern.o rdsspy.o scan.o settings.o sha1.o $(LIBS)
...
gui.o:				gui.c gui.h connection.h graph.h menu.h settings.h clipboard.h keyboard.h
					$(CC) $(CFLAGS) gui.c
...
main.o:				main.c gui.h settings.h graph.h rdsspy.h
					$(CC) $(CFLAGS) main.c
...
settings.o:			settings.c gui.h settings.h graph.h menu.h rdsspy.h
