...
#define CONF_RDS_EXTENDED_CHECK   FALSE
#define CONF_RDS_PS_INFO_ERROR    LARGE_ERR_CORR
#define CONF_RDS_PS_DATA_ERROR    SMALL_ERR_CORR
#define CONF_RDS_PS_PROGRESSIVE   FALSE
#define CONF_RDS_PS_PROG_OVERRIDE TRUE
#define CONF_RDS_RT_INFO_ERROR    NO_ERR_CORR
#define CONF_RDS_RT_DATA_ERROR    NO_ERR_CORR
#define CONF_RDS_RT_PROGRESSIVE   TRUE
#define CONF_RDS_RT_PROG_OVERRIDE TRUE
